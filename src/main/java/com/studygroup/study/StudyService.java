...
import static com.studygroup.study.form.StudyForm.VALID_PATH_PATTERN;
...
public class StudyService {
    ...
    public void startRecruit(Study study){ study.startRecruit(); }
    public void stopRecruit(Study study){ study.stopRecruit(); }
