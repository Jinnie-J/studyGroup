...
public class StudyController {
    ...
    public String joinStudy(@CurrentAccount Account account, @PathVariable String path) throws UnsupportedEncodingException {
    ...
    public String leaveStudy(@CurrentAccount Account account, @PathVariable String path) throws UnsupportedEncodingException {
        Study study = studyRepository.findStudyWithMembersByPath(path);
        studyService.removeMember(study, account);
        return "redirectL/study" + study.getEncodedPath() + "/members";
    }
