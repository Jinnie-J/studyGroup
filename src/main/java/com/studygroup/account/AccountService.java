...
import com.studygroup.config.AppProperties;
import com.studygroup.domain.Account;
import com.studygroup.domain.Tag;
import com.studygroup.domain.Zone;
import com.studygroup.mail.EmailMessage;
import com.studygroup.mail.EmailService;
...
public class AccountService implements UserDetailsService {
    ...
    public void sendLoginLink(Account account) {
        ...
        context.setVariable("linkname","스터디그룹 로그인하기");
        context.setVariable("message", "로그인 하려면 아래 링크를 클릭하세요.");
        context.setVariable("host",appProperties.getHost());
        String message= templateEngine.process("mail/sinple-link",context);

        EmailMessage emailMessage = EmailMessage.builder()
                .to(account.getEmail())
                .subject("스터디 그룹, 로그인 링크")
                .message(message)
                .build();
